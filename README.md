...
```bash
docker run --rm -p 8888:8788 ghcr.io/pmoses-s1/s1-ingest-health-deployer:latest
```
...
docker run --rm -p 8888:8788 --env-file .env ghcr.io/pmoses-s1/s1-ingest-health-deployer:latest
```
